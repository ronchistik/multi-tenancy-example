...
// Typography Tab
function TypographyTab({ config, baseConfig, onChange, isOverridden, resetValue }: any) {
...
// Spacing Tab
function SpacingTab({ config, baseConfig, onChange, isOverridden, resetValue }: any) {
...
// Borders Tab
function BordersTab({ config, baseConfig, onChange, isOverridden, resetValue }: any) {
